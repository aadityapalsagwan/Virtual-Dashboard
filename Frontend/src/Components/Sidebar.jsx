                    ...
                    <li className="navbar-sb-link my-3">
                        <Link to="/year" className="text-decoration-none d-flex align-items-center justify-content-between">
                            <div className="text-light-blue d-flex align-items-center">
                                ...
                                <span className="navbar-sb-text fs-14 fw-5 text-capitalize"> Start Year</span>
                            </div>
                        </Link>
                    </li>
                    <li className="navbar-sb-link my-3">
                        <Link to="/endyear" className="text-decoration-none d-flex align-items-center justify-content-between">
                            <div className="text-light-blue d-flex align-items-center">
                                <span className="navbar-sb-icon me-3">
                                    <i className="fa-solid fa-spinner"></i>
                                </span>
                                <span className="navbar-sb-text fs-14 fw-5 text-capitalize">End Year</span>
                            </div>
                        </Link>
                    </li>
                    <li className="navbar-sb-link my-3">
